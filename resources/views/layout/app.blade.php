    ...
    <div class="app-container">
        <div class="sidebar">
            ...
            <ul class="sidebar-list">
                <li class="sidebar-list-item {{ Request::routeIs('dashboard') ? 'active' : '' }}">
                ...
                <li class="sidebar-list-item {{ Request::routeIs('student') ? 'active' : '' }}">
                ...
                <li class="sidebar-list-item {{ Request::routeIs('course') ? 'active' : '' }}">
                    <a href="{{ route('course') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <li class="sidebar-list-item {{ Request::routeIs('fee') ? 'active' : '' }}">
                    <a href="{{ route('fee') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <li class="sidebar-list-item {{ Request::routeIs('student-fee') ? 'active' : '' }}">
                ...
                <li class="sidebar-list-item {{ Request::routeIs('payment') ? 'active' : '' }}">
                ...
                <li class="sidebar-list-item {{ Request::routeIs('payment-report') ? 'active' : '' }}">
                ...
                <li class="sidebar-list-item {{ Request::routeIs('changed-password') ? 'active' : '' }}">
                    <a href="{{ route('changed-password') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-inbox">
                            <polyline points="22 12 16 12 14 15 10 15 8 12 2 12" />
        ...
        <div class="app-content">
            <div class="app-content-header">
                <h1 class="app-content-headerText">Fee Management System</h1>
